...
#define EXAMPLE_PIN_NUM_LCD_TE            (GPIO_NUM_11) //未使用

#define EXAMPLE_PIN_NUM_TOUCH_SCL         (GPIO_NUM_40)
#define EXAMPLE_PIN_NUM_TOUCH_SDA         (GPIO_NUM_39)
#define EXAMPLE_PIN_NUM_TOUCH_RST         (GPIO_NUM_41)
